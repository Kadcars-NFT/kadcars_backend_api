...
# Code follows:
var.registers(['prepareCmdHash', 'b64urlDecodeArr', 'hash', 'strToUint8Array', 'b64url', 'uint8ArrayToStr', 'b64urlEncodeArr', 'hashBin'])
@Js
...
def PyJs_anonymous_0_(this, arguments, var=var):
    ...
    var.registers(['base64UrlEncode', 'InvalidCharacterError', 'base64UrlDecode', 'chars'])
    @Js
    ...
    def PyJsHoisted_base64UrlEncode_(input, this, arguments, var=var):
        var = Scope({'input':input, 'this':this, 'arguments':arguments}, var)
        var.registers(['block', 'charCode', 'str', 'output', 'input', 'idx', 'map'])
    ...
    def PyJsHoisted_base64UrlDecode_(input, this, arguments, var=var):
        var = Scope({'input':input, 'this':this, 'arguments':arguments}, var)
        var.registers(['bs', 'bc', 'str', 'buffer', 'output', 'input', 'idx'])
